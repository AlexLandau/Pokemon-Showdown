// Copied from simulate, to begin with.
...
// console.log("keys: " + Object.getOwnPropertyNames(Dex));
// console.log("dexes: " + Object.keys(Dex.dexes));
// console.log("gen1: " + Object.keys(Dex.dexes.gen1));

// Dex.mod("gen1");
// Dex.forFormat("gen1customgame");

// console.log("keys: " + Object.keys(Dex));
// console.log("typeCache: " + Object.keys(Dex.typeCache));
// console.log("formatsCache: " + Object.keys(Dex.formatsCache));
// console.log("gen: " + Object.keys(Dex.gen));
// console.log("g1cg: " + Object.keys(Dex.formatsCache.gen1customgame));
